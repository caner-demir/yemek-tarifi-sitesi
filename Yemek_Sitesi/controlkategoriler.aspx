<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="controlkategoriler.aspx.cs" Inherits="Yemek_Sitesi.Kategoriler" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="auto-style61" Font-Names="Segoe UI">
        <table class="auto-style48">
            <tr>
                ...
                <td class="auto-style64">Kategori Listesi:</td>
                ...
                <table class="auto-style48">
                    <tr>
                        <td class="auto-style51">
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("KategoriAd") %>' CssClass="auto-style52" Font-Names="Segoe UI"></asp:Label>
                        </td>
                        <td class="auto-style63">
                            <a href="controlkategoriler.aspx?kategoriid=<%# Eval("KategoriID") %>&islem=sil"><asp:Image ID="Image2" runat="server" Height="32px" ImageUrl="~/Resimler/delete-icon.png" Width="32px" />
                                </a>
                        </td>
                        <td class="auto-style49">
                            <a href="detailskategori.aspx?kategoriid=<%# Eval("KategoriID") %>"><asp:Image ID="Image3" runat="server" Height="32px" ImageUrl="~/Resimler/refresh.png" Width="32px" />
                                </a> 
                        </td>
                    </tr>
                </table>
    ...
    <asp:Panel ID="Panel3" runat="server" CssClass="auto-style61" Font-Names="Segoe UI">
            ...
            <table class="auto-style48">
                <tr>
                    ...
                    <td class="auto-style53">Kategori Ekle:</td>
                </tr>
            </table>
    ...
    <asp:Panel ID="Panel4" runat="server" CssClass="auto-style47" Font-Names="Segoe UI" Style="background-color: #000; background-size: auto; padding-bottom:10px; padding-top:10px; color: #e4e4e4;">
        <table class="auto-style48" style="padding-bottom: 10px; padding-top: 10px">
            <tr>
                <td class="auto-style59" style="font-family: 'Segoe UI'"><strong>Kategori Adı:</strong></td>
            ...
            <tr>
                ...
                <td class="auto-style56" style="font-family: 'Segoe UI'">
                    <strong>
                    <asp:Button ID="ButtonEkle" runat="server" BackColor=White CssClass="auto-style26" Text="Ekle" Width="150px" Font-Names="Segoe UI" style="font-size: large; font-weight: bold" OnClick="ButtonEkle_Click" />
                    </strong>
                </td>
            </tr>
        </table>
