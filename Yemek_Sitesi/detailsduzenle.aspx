<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="detailsduzenle.aspx.cs" Inherits="Yemek_Sitesi.YemekDuzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
    <table class="auto-style46" Style="background-color: #000; background-size: auto; padding-bottom: 10px; color: #e4e4e4;">
        ...
        <tr>
            <td class="auto-style50"><strong>Yemek Resim:</strong></td>
            <td>
        ...
        <tr>
            ...
            <td>
                <strong>
                <asp:CheckBox ID="CheckBox1" runat="server" CssClass="auto-style63" Font-Names="Segoe UI" Text="Günün Yemeği" />
                </strong>
            </td>
        </tr>
        <tr>
