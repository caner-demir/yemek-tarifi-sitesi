<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="controloneriler.aspx.cs" Inherits="Yemek_Sitesi.OnerilerAdmin" %>
                ...
                <table class="auto-style48">
                    <tr>
                        <td class="auto-style51">
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("TarifAd") %>' CssClass="auto-style52" Font-Names="Segoe UI"></asp:Label>
                        </td>
                        <td class="auto-style7">
                            <a href='detailsoneri.aspx?tarifid=<%# Eval("TarifID") %>'>
